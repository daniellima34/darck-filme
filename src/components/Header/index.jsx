...
export default function Header({showButton = true}){
    return(
        <header className="w-full h-[50px] flex bg-[#0C0F15] justify-between pr-2 items-center">
            ...
            className="flex h-full gap-2 items-center justify-cente pl-2 cursor-pointer">
            ...
            {showButton &&(
                ...
                className="w-[150px] h-[60%] rounder-md bg-[#9b87f5] text-white font-bold hover:bg-[#9b87f5]/70 ">Adicionar Filme</button>
            )}
